...
def reinforce(args):
    ...
    log2file_vpg(log_file, "VPG", "MountainCar")
    torch.save(agent.actor_critic.state_dict(), "VPG_MountainCar.h5")
    env.close()
...
def ddpg_new(args):
    ...
    log2file_ddpg(log_file, "DDPG", "MountainCar")
    torch.save(new_DDPG_agent.actor.state_dict(), "DDPG_MountainCar.h5")
    env.close()
