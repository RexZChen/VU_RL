...
Reference: OpenAI Implementation of Replay Buffers
           See code at https://github.com/openai/spinningup
...
class DDPGBuffer:
    ...
    def add_transitions(self, transition):
        """
        :param transition:  (s, a, r, done, s_next)
        """
